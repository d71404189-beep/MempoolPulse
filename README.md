...
> Real-time multi-chain mempool monitor (Ethereum, Arbitrum, Base, BNB Chain) for spotting whale transactions before they confirm.
...
- v1.1 — Arbitrum, Base, BNB Chain (this release)
